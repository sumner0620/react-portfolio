...
export const Slalom = () => {
  ...
  function initGame() {
    fieldCanvas.start();
    jet = new SlalomComponent(10, 20, "white", 300, 560);
    wall.push(new SlalomComponent(10, 10, "red", 400, 0));
    wall[0].speedY = 1;
  ...
  const updateGameArea = () => {
    ...
    if (wall[wall.length - 1].y >= 5) {
      ...
      wall.push(new SlalomComponent(10, 10, newObj.color, newX, 0));
    }
    wall.forEach(component => {
